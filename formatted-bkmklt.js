...
var fieldMappings = [
  ...
  { patterns: ["whatsapp no", "whatsapp number"], value: "987654" },
  {
    patterns: [
      "email",
      "your email",
      ...
      if (mapping.patterns.some((pattern) => questionText.includes(pattern))) {
        if (
          ...
          if (dropdown.length > 0) {
            // console.log("--dropdown : q---", questionText);
            ...
            console.log("--radio : q---", questionText);
            ...
            for (const radio of radios) {
              ...
              if (mapping.possibleValues) {
                ...
                var normalized = normalizeString(radioValue);
                  console.log("--found radio---", normalized);

                if (
                  mapping.negPossibleValues &&
                  mapping.negPossibleValues.includes(normalized)
                ) {
                  console.log("neg-values found");
                  continue;
                }
                if (mapping.possibleValues.includes(normalized)) {
                  console.log("--found radio ans:", normalized);
                  radio.click();
                  break;
                }
              }
            ...
            // console.log("--input : q---", questionText);
